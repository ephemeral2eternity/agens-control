...
cat $f | while read LINE; do
	...
	gcloud compute instances create $agent_name --image django-cache-agent --machine-type f1-micro --zone $agent_zone --scope compute-rw storage-full userinfo-email
	...
	echo "Sleep 20 seconds for server to start running......."
	sleep 20
